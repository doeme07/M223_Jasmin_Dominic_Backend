...
public class UserMapperImpl implements UserMapper {
    ...
    public User fromDTO(UserDTO dto) {
        ...
        Set<MyListEntry> set1 = dto.getMyListEntries();
        if ( set1 != null ) {
            user.setMyListEntries( new LinkedHashSet<MyListEntry>( set1 ) );
        }
    ...
    public UserDTO toDTO(User BO) {
        ...
        Set<MyListEntry> set1 = BO.getMyListEntries();
        if ( set1 != null ) {
            userDTO.setMyListEntries( new LinkedHashSet<MyListEntry>( set1 ) );
        }
